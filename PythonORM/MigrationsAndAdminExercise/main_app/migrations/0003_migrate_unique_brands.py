# Generated by Django 5.0.4 on 2024-07-04 16:53
...
def create_unique_brands(apps, schema_editor):
    ...
    unique_shoe_brands = shoe.objects.values_list('brand', flat=True).distinct()
    unique_brands.objects.bulk_create([unique_brands(brand=brand_name) for brand_name in unique_shoe_brands])
